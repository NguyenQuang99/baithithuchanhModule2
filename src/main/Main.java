...
public class Main {
    ...
    public static void updateInfo(Contact contact) throws Exception {
        System.out.println("Nhập vào danh bạ :");
        String number = scanner.next();
        if (!number.matches("\\{9,10}")) {
        ...
        System.out.println("Danh bạ đã khởi tạo");
            ...
            switch (choice) {
                case "1":
                    ...
                    if (manager.checkStatus()) {
                        ...
                        do {
                            System.out.println("Nhấn enter đẻ tiếp tục");
                ...
                case "2":
                    ...
                    try {
                        ...
                        System.out.println("Két thúc");
                    }
                    break;
                case "3":
                    String input;
                    do {
                        System.out.println("Nhập vào số diện thoai");
                ...
                case "4":
                    do {
                        System.out.println("Nhập vào số điện thoaik");
                        input = scanner.nextLine();
                        Contact contactSearch = manager.searchByNumber(input);
                        if (contactSearch == null) {
                            System.out.println("Không tìm thấy danh bạ");
                ...
                case "7":
                    try {
                       fileService.exportToCSV("src/contacts.csv", manager);
                    } catch (IOException e) {
